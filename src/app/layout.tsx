...
import { DM_Serif_Display, DM_Sans, Libertinus_Serif, Bungee, Orbitron, Abril_Fatface} from "next/font/google";
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  description: "Expert legal guidance tailored to your needs, for individuals and businesses alike.",
};
